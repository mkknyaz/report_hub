...
public class PlansService(ISender sender) : BaseService
{
    ...
    [HttpGet]
    public async Task<IActionResult> GetPlansByClientId([FromQuery][Required] Guid clientId)
    {
    ...
    [Authorize(Policy = Constants.Authorization.Policy.Read)]
    [HttpGet("{id:guid}")]
    public async Task<IActionResult> GetPlanById([FromRoute] Guid id, [FromQuery][Required] Guid clientId)
    {
    ...
    [HttpDelete("{id:guid}")]
    public async Task<IActionResult> DeletePlan([FromRoute] Guid id, [FromQuery][Required] Guid clientId)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> UpdatePlan([FromRoute] Guid id, [FromBody] UpdatePlanDTO updatePlanDateDto)
    {
