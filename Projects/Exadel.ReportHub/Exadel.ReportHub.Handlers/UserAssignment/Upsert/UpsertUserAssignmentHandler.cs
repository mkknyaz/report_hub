...
public record UpsertUserAssignmentRequest(UpsertUserAssignmentDTO UpsertUserAssignmentDto) : IRequest<ErrorOr<Updated>>;
...
public class UpsertUserAssignmentHandler(IUserAssignmentRepository userAssignmentRepository, IMapper mapper) : IRequestHandler<UpsertUserAssignmentRequest, ErrorOr<Updated>>
{
    ...
    {
        var userAssignment = mapper.Map<Data.Models.UserAssignment>(request.UpsertUserAssignmentDto);
